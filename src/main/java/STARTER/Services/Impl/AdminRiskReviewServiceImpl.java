...
public class AdminRiskReviewServiceImpl implements AdminRiskReviewService {
    ...
    public List<AdminRiskAssessmentViewDTO> listRiskReviews() {
        ...
        try {
            ...
            throw new RiskReviewServiceException(
                    ...
                    "Cannot load risk reviews. Make sure the microservice is running on port 8081."
    ...
    public long countPendingReviews() {
        ...
        try {
            ...
            return riskAssessmentClient.listAssessments(AssessmentStatus.PENDING.name(), null)

                    .stream()

                    .filter(assessment -> assessment.getDecision() == RiskDecision.REVIEW)
